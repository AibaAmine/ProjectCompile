...
{
       0,    74,    74,    78,    79,    81,    93,   108,   128,   133,
...
#line 169 "syntax.y"
  ...
  // Add semantic checks
    verifierDeclaration((yyvsp[(1) - (4)].str)); // Check if variable is declared
    verifierConstanteModification((yyvsp[(1) - (4)].str)); // Check if trying to modify a constant
